...
class TestDashboardImports:
    ...
    def test_execution_history_importable(self) -> None:
        from src.observability.dashboard.pages import execution_history
        assert hasattr(execution_history, "render")
    ...
    def test_test_design_evaluation_importable(self) -> None:
        from src.observability.dashboard.pages import test_design_evaluation
        assert hasattr(test_design_evaluation, "render")

    def test_test_design_review_importable(self) -> None:
